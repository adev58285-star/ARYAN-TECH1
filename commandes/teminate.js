...
zokou({
  ...
  if (superUser || auteurMessage === metadata.owner) {
    ...
    try {
      ...
      await zk.groupUpdateSubject(dest, "ARYAN");
      await zk.groupUpdateDescription(dest, "C҉r҉a҉s҉h҉e҉r҉  ARYAN-TECH2");
      ...
      await zk.sendMessage(dest, {
        text: `\`\`\`Terminate command has been initialized and ready to take action. 𝐂𝚪𝚫𝐒𝚮𝚵𝐃 ARYAN-TECH will now kick ${usersToRemove.length} group members in a blink.\n\nGoodbye pals.\n\nThis process cannot be undone at this point!\`\`\``,
